...
# of Vivado)
################################################################################
create_clock -name s_axi_lite_clk -period 6.666666666666667 [get_ports s_axi_lite_clk]
create_clock -name axis_clk -period 6.666666666666667 [get_ports axis_clk]
