...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set_property -dict [ list CONFIG.C_ECC {0} CONFIG.C_MASK {0xc0000000}  ] $dlmb_bram_if_cntlr
  ...
  set_property -dict [ list CONFIG.C_ECC {0} CONFIG.C_MASK {0x80000000}  ] $ilmb_bram_if_cntlr
  ...
  set_property -dict [ list CONFIG.Enable_B {Use_ENB_Pin} CONFIG.Memory_Type {True_Dual_Port_RAM} CONFIG.Port_B_Clock {100} CONFIG.Port_B_Enable_Rate {100} CONFIG.Port_B_Write_Rate {50} CONFIG.Use_RSTB_Pin {true} CONFIG.use_bram_block {BRAM_Controller}  ] $lmb_bram
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ETHERNET_BOARD_INTERFACE {gmii} CONFIG.MDIO_BOARD_INTERFACE {mdio_io} CONFIG.PHYRST_BOARD_INTERFACE {phy_reset_out} CONFIG.RXCSUM {Full} CONFIG.RXMEM {32k} CONFIG.TXCSUM {Full} CONFIG.TXMEM {32k} CONFIG.USE_BOARD_FLOW {true}  ] $axi_ethernet_0
  ...
  set_property -dict [ list CONFIG.c_include_mm2s_dre {1} CONFIG.c_include_s2mm_dre {1} CONFIG.c_mm2s_burst_size {32} CONFIG.c_s2mm_burst_size {32} CONFIG.c_sg_use_stsapp_length {1}  ] $axi_ethernet_0_dma

  # Create instance: axi_mem_intercon, and set properties
  set axi_mem_intercon [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_mem_intercon ]
  set_property -dict [ list CONFIG.M00_HAS_REGSLICE {4} CONFIG.M01_HAS_REGSLICE {4} CONFIG.NUM_MI {2} CONFIG.NUM_SI {5} CONFIG.S00_HAS_REGSLICE {4} CONFIG.S01_HAS_REGSLICE {4} CONFIG.S02_HAS_REGSLICE {4} CONFIG.S03_HAS_REGSLICE {4} CONFIG.S04_HAS_REGSLICE {4} CONFIG.STRATEGY {2}  ] $axi_mem_intercon
  ...
  set_property -dict [ list CONFIG.C_S_AXI_ACLK_FREQ_HZ {150000000} CONFIG.UARTLITE_BOARD_INTERFACE {rs232_uart} CONFIG.USE_BOARD_FLOW {true}  ] $axi_uartlite_0
  ...
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {66.66000000000001} CONFIG.CLKOUT1_JITTER {150.364} CONFIG.CLKOUT1_PHASE_ERROR {164.985} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {125.0} CONFIG.PRIM_SOURCE {Global_buffer} CONFIG.USE_BOARD_FLOW {false}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.C_CACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_ALWAYS_USED {1} CONFIG.C_DCACHE_BASEADDR {0x80000000} CONFIG.C_DCACHE_BYTE_SIZE {32768} CONFIG.C_DCACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_DCACHE_LINE_LEN {8} CONFIG.C_DCACHE_USE_WRITEBACK {1} CONFIG.C_DCACHE_VICTIMS {4} CONFIG.C_DEBUG_ENABLED {1} CONFIG.C_D_AXI {1} CONFIG.C_D_LMB {1} CONFIG.C_FREQ {200000000} CONFIG.C_ICACHE_ALWAYS_USED {1} CONFIG.C_ICACHE_BASEADDR {0x80000000} CONFIG.C_ICACHE_HIGHADDR {0xBFFFFFFF} CONFIG.C_ICACHE_LINE_LEN {8} CONFIG.C_ICACHE_STREAMS {1} CONFIG.C_ICACHE_VICTIMS {4} CONFIG.C_I_LMB {1} CONFIG.C_M_AXI_DC_USER_SIGNALS {0} CONFIG.C_M_AXI_IC_USER_SIGNALS {0} CONFIG.C_USE_BARREL {1} CONFIG.C_USE_BRANCH_TARGET_CACHE {1} CONFIG.C_USE_DCACHE {1} CONFIG.C_USE_DIV {1} CONFIG.C_USE_EXT_BRK {0} CONFIG.C_USE_EXT_NM_BRK {0} CONFIG.C_USE_FPU {2} CONFIG.C_USE_HW_MUL {2} CONFIG.C_USE_ICACHE {1} CONFIG.C_USE_INTERRUPT {2} CONFIG.C_USE_MSR_INSTR {1} CONFIG.C_USE_PCMP_INSTR {1} CONFIG.G_TEMPLATE_LIST {2}  ] $microblaze_0

  # Create instance: microblaze_0_axi_intc, and set properties
  set microblaze_0_axi_intc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 microblaze_0_axi_intc ]
  set_property -dict [ list CONFIG.C_ASYNC_INTR {0xFFFFFFE1} CONFIG.C_DISABLE_SYNCHRONIZERS {1} CONFIG.C_HAS_FAST {1} CONFIG.C_KIND_OF_INTR {0xFFFFFFE8}  ] $microblaze_0_axi_intc
  ...
  set_property -dict [ list CONFIG.BOARD_MIG_PARAM {Custom} CONFIG.MIG_DONT_TOUCH_PARAM {Custom} CONFIG.RESET_BOARD_INTERFACE {reset} CONFIG.XML_INPUT_FILE {mig_b.prj}  ] $mig_7series_0
  ...
  connect_bd_intf_net -intf_net axi_ethernet_0_mdio [get_bd_intf_ports mdio_io] [get_bd_intf_pins axi_ethernet_0/mdio_io]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_0_dma/m_axi_mm2s_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_s2mm_aclk] [get_bd_pins axi_ethernet_0_dma/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0_dma/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0_dma/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset] [get_bd_pins mig_7series_0/sys_rst]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_SG] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_MM2S] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x10000 -offset 0xC0000000 [get_bd_addr_spaces axi_ethernet_0_dma/Data_S2MM] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  ...
  create_bd_addr_seg -range 0x40000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs axi_ethernet_0/s_axi/Reg] SEG_axi_ethernet_0_Reg
